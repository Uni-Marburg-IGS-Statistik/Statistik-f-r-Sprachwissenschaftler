...
Die Anzahl guter Noten ist deutlich geringer als die Anzahl schlechter Noten.Die Diskrepanz zwischen der Anzahl guter und schlechter Noten wird aber mit zunehmender Standardabweichung geringer. 

Warum?

Es gibt mehr schlechte Noten, da wir eine größere Range von schlechten Noten im Vergleich zu guten Noten betrachten: als gute Noten haben wir nur 13 Punkte oder größer, also 13,14 und 15 Punkte, betrachtet, für schlechte Noten jedoch 0,1,2,3,4,5 Notenpunkte.
...
Die Verteilung der Noten mit mehr guten Noten ist dementsprechend linksschief.
...
2. Wie viele Studenten bekommen zumindest 10 NP?
   ...
   `r (pnorm(10,mean=mu,sd=3,lower.tail=FALSE)) * n` Studenten bekommen mindestens 10 NP

3. Wie viele Studenten bekommen weniger als 10 NP?

   `r (pnorm(10,mean=mu,sd=3)) * n` Studenten bekommen weniger als 10 NP
