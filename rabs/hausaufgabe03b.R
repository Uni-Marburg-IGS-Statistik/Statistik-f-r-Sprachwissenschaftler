...
# Nein, wenn mehrere Elemente gleich häufig vorkommen, kann es mehrere Modi geben. Der Code ist trotzdem grundlegend
# korrekt, falls wir nur den Modalwert an sich abrufen möchten. Möchten wir aber außerdem die damit zusammenhängenden
# Elemente abrufen, müsste man den Code so ändern, dass alle Werte, die sich den ersten Platz in dieser sortierten
# Tabelle teilen, ausgegeben werden. (Gibt es if-Schleifen in R?)
