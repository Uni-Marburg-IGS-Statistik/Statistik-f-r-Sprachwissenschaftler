...
Bei den Punkten in der jitter Darstellung erkennt man den Trend praktisch gar nicht. Man kann aber sehen wie die eintzelnen Versuchspersonen abgeschnitten haben.
...
IQR*1,5. Die werte die außerhalb liegen, sind als Punkte dargestellt (meist Ausreißer). Damit zeigt die Boxplot Darstellung die meisten statistisch relevanten Informationen. Die eigentliche Verteilung der Rohwerte innerhalb der Bedingungen sieht man aber in der "violin"" Darstellung am besten.
