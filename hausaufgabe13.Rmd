...
- Density-Darstellung: Höhepunkte lassen sich sehr gut ablesen (welche Bedinung, welche Reaktionszeit am häufigsten), allerings sehr unübersichtlich bei Darstellung der mittl. Häufigkeit
- Jitter-Darstellung: Trend lässt sich nicht erkennen, einzelne Punkte werden durch Rauschen verzerrt
- Violin-Darstellung: Verteilung bei den jew. Bedinungen sehr gut ablesbar und vergleichbar
- Boxplot-Darstellung: nur hier wird Median angezeigt!, IQR sichtbar, Whiskers, Ausreißer (=statistisch relevanten Daten sind hier am besten ablesbar (exkl. Rohwerte, die sind in Violin-Darstellung am besten ablesbar))
...
IQR in der Item-Verteilung ist in allen Bedinungen kleiner (Median sehr änlich). Demzufolge sind die Whiskers kürzer (gibt dennoch nicht mehr Ausreißer). Die Daten by Item zeigen, dass eine geringere Streuung als bei den Versuchspersonen vorliegt (aber in ähnlichen Bereichen). Daraus lässt sich schließen, dass in diesem Fall Items die besseren Prädikatoren als Vpn sind. 
