...
# Nein, es kann auch mehrere Modi geben, also mehrere Maxima, die gleich häufig sind. 
# Der Code oben stimmt daher nur für unimodale Verteilungen, da nach der Sortierung
# einfach der erste Wert ausgelesen wird. Der Code macht keine Aussage darüber, ob es
# noch weitere Modalwerte gibt. 
