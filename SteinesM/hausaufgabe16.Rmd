...
#### Plots
Um einen ersten Eindruck der Daten zu erhalten, sollte man diese plotten. Die Haupthypothese könnte folgende sein: je mehr Karat ein Diamant besitzt, desto teurer ist er. Aber vielleicht beieinflussen auch Farbe, Schliff und Reinheit den Preis.
...
```
Die Abhängigkeit von Preis und Karat wird als signifikant angegeben, mit einem R^2 von 84.93%.
