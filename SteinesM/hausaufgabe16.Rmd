...
Ein Teil der Varianz bleibt also noch unaufgeklärt. Sprich der Preis eines Diamanten hängt nicht *allein* von Karat ab. Da die Angaben zu Farbe, Schliff und Reinheit der Diamanten nicht intervallskaliert sind, kommen wir hier mit linearer Regression nicht weiter. Wir können allerdings schnell die Hypothese testen und bestätigen, dass der Karatwert eines Diamanten selbst, der aus dessen Gewicht hervorgeht, stark vom Volumen abhängt:
